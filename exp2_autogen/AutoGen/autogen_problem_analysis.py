...
class AutoGenProblemAnalysis:
    ...
    def plot_problem_status_count(self):
        ...
        colors = ["#1f77b4", "#ff7f0e", "#ff0000"]  # Blue for pass, Orange for fail, red for errors
        problem_status_count_new.plot(kind='bar', stacked=True, color=colors, figsize=(12, 6))

        plt.title('Number of Pass and Fail Test Cases for Each Problem Using AutoGen', fontsize=20)
    ...
    def plot_problem_category_distribution(self):
        ...
        plt.title('AutoGen - Distribution of Problem Categories', fontsize=20)
    ...
    def plot_pass_rate_pie_chart(self):
        ...
        plt.title('AutoGen - Pass Rate of Solutions', fontsize=20)
    ...
    def plot_problem_index_vs_status(self):
        ...
        plt.title('AutoGen - Problem Index vs. Pass/Fail Status', fontsize=20)
    ...
    def plot_problem_statement_length_histogram(self):
        ...
        plt.title('AutoGen - Histogram of Problem Statement Lengths', fontsize=20)
    ...
    def plot_success_rate_by_difficulty(self):
        ...
        """
        success_rate_by_difficulty = self.document_df.groupby('category')['pass'].mean() * 100

        plt.figure(figsize=(10, 6))
        bar_plot = sns.barplot(x=success_rate_by_difficulty.index, y=success_rate_by_difficulty.values, palette='viridis')
        plt.title('AutoGen - Problem Difficulty vs. Success Rate', fontsize=20)
        ...
        # Adding the success rate values on top of the bars
    ...
    def plot_problem_type_and_category(self):
        ...
        plt.title('AutoGen - Success and Failure Analysis by Problem Type and Category', fontsize=20)
...
if __name__ == "__main__":
    analysis = AutoGenProblemAnalysis("work_dir/1_Prompt1_AutoGen_031_NaiveApproach.csv")
